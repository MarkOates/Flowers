...
TEST(Flowers_FlowerTest, has_black_petals__returns_true_if_the_petals_are_black)
{
   Flowers::Flower flower;
   flower.set_petal_color(al_color_name("black"));
   ASSERT_EQ(true, flower.has_black_petals());
   flower.set_petal_color(al_color_name("green"));
   ASSERT_EQ(false, flower.has_black_petals());
}
